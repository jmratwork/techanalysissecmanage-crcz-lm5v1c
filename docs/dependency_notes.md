...
- `nmap`: Used in `legacy/subcase_1b/scripts/trainee_start.sh` to perform port scans. This Subcase 1b helper is archived and retained only for reference; Nmap remains an approved scanning utility.
