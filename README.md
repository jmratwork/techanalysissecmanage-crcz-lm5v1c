...
- **Flavor alignment:** The Terraform backend currently exposes only the `small` flavor; keep `topology.yml` and all sandbox definitions on that flavor to avoid import failures.
